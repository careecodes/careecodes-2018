// UTILS/DUMMY DATA - courtesy of chart.js docs
'use strict';
...
var MONTHS = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
		...
		var horizontalBarChartData = {
			...
			datasets: [{
				...
				borderColor: window.chartColors.feijoa,
				borderWidth: 1,
				data: [
					randomScalingFactor(),
					randomScalingFactor(),
				...
				label: 'Medium',
				backgroundColor: window.chartColors.viking,
				borderColor: window.chartColors.viking,
				data: [
					randomScalingFactor(),
					randomScalingFactor(),
					randomScalingFactor(),
      ...
      {
				label: 'High',
				backgroundColor: window.chartColors.capehoney,
				borderColor: window.chartColors.capehoney,
				data: [
					randomScalingFactor(),
					randomScalingFactor(),
					randomScalingFactor(),
      ...
      {
				label: 'Critical',
				backgroundColor: window.chartColors.tangerine,
				borderColor: window.chartColors.tangerine,
				data: [
					randomScalingFactor(),
					randomScalingFactor(),
					randomScalingFactor(),
...
window.onload = function() {
  ...
  window.myHorizontalBar = new Chart(ctx_1, {
    type: 'horizontalBar',
